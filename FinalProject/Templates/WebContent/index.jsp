...
<%@include file="db.jsp"%>
<%
String qr="select * from ServiceProvider where semail=?";
     ...
     <section class="navbar navbar-default navbar-static-top" role="navigation">
          <div class="container">
               ...
               <div class="navbar-header">
                    ...
                    <!-- lOGO TEXT HERE -->
                    <a href="index.html" class="navbar-brand"><i class="fa fa-h-square"></i>ealth Center  <%="Logined as " + email%></a>
                   </div>
               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                         ...
                         <li><a href="SPLogout.jsp" class="smoothScroll">Logout</a></li>
                         <li><a href="#team" class="smoothScroll">Doctors</a></li>
                        
                         <li><a href="#google-map" class="smoothScroll">SignUp</a></li>
                         <li class="appointment-btn"><a href="#appointment">Add Service</a></li>
                          <li class="appointment-btn"><a href="table.jsp?sid=<%=sid%>">Show Appointments</a></li>
                    </ul>
               </div>
     ...
     <section id="appointment" data-stellar-background-ratio="3">
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
                         <!-- CONTACT FORM HERE -->
                         <form id="appointment-form" role="form" method="post" action="Addser.jsp">
                              ...
                              <div class="wow fadeInUp" data-wow-delay="0.8s">
                                   <div class="col-md-6 col-sm-6">
                                        <label for="name">Unique-ID of Service</label>
                               ...
                               <div class="col-md-6 col-sm-6">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        ...
                                        <input type="time" name="t" value="" class="form-control">
                                   </div>
                                   <div class="col-md-6 col-sm-6">
                                        <label for="time">Time(To)</label>
                                        <input type="time" name="t1" value="" class="form-control">
                                   </div>
                                   <div class="col-md-6 col-sm-6">
                                        <label for="select">Select Department</label>
                                        <select class="form-control" name="tyservice">
...
<input type="checkbox" name="a" value="Sat">Saturday
                                   <div class="col-md-12 col-sm-12">
                                        ...
                                        <input type="tel" class="form-control" name="mnumber" placeholder="Phone">
